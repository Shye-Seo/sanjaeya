...
<body>
	...
	<div id = "title_wrap">
		...
		<div class = "board_btnarea">
			<input type="button" id = "noticebtn" class="select_board_btn" onclick="location.href='board_list'" value="공지사항" />
        ...
        <c:forEach var="nl" items="${board_list}" varStatus="st">
        	<table id="mobile_list">
				<tr id="mlist">
					...
					<td id="icon" rowspan="2"><a href="readView?id=${nl.id}"><img src="resources/imgs/mobile_list_icon.svg"></a></td>
				</tr>
				<tr id="mdate_area">

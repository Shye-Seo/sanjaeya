	...
	<body>
		...
		<!-- 게시글 등록하기 영역 -->
			...
			<form id="uploadForm" method = "POST" action = "update" enctype="multipart/form-data">
				...
				<input type = "hidden" name ="board_id" value = "${board_id}" id="board_id"/>
					<table border=1>
						<tr>
							<td class="td1"><span>제목</span></td>
							<td><input type="text" name="title" id="title" class="td2" value="${update.title}"></td>
						</tr>
						<tr>
							<td class="td3"><span>작성자</span></td>
							<td><input type="text" name="writer" id="writer" class="td4" value="${update.writer}" disabled></td>
						</tr>
						<tr>

...
<!--   					<input type = "text" name="title" id="title" class = "BoardController" placeholder="제목을 입력하세요."> -->
<!--   					<label>작성자</label> -->
...
<!-- 								<input type="file" id="input_file" multiple="multiple" name="file"/> -->
<!-- 								<label for="input_file">파일 추가</label> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 				</div> -->
